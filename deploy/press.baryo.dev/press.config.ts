...
/*
 * press.baryo.dev's configuration. This directory is laid over the reference app by passing
 * PRESS_DEPLOY=press.baryo.dev to the build, so the root press.config.ts and the tenant routes
 * beside it stay as they are: they are the fixture scripts/two-hosts.sh proves request-time
 * identity against.
 *
